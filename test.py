...
if __name__ == '__main__':
    ...
    checkpoint = torch.load(os.path.join('checkpoints', args.name, 'checkpoint_best_macro.pt'.format(args.extra)),
                            map_location='cpu')
    ...
    print(args)
    data_path = os.path.join(args.data if 'data' in args else data_path)
